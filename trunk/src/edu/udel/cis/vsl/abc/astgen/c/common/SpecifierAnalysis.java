...
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.ABSTRACT;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.ALIGNAS;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.ATOMIC;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.AUTO;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.BOOL;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.CHAR;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.COMPLEX;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.CONST;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.DOMAIN;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.DOUBLE;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.ENUM;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.EXTERN;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.FATOMIC;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.FLOAT;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.GLOBAL;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.INLINE;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.INPUT;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.INT;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.LONG;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.NORETURN;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.OUTPUT;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.RANGE;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.REAL;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.REGISTER;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.RESTRICT;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.SHARED;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.SHORT;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.SIGNED;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.STATIC;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.STRUCT;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.THREADLOCAL;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.TYPEDEF;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.TYPEDEF_NAME;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.TYPEOF_EXPRESSION;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.TYPEOF_TYPE;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.UNION;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.UNSIGNED;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.VOID;
import static edu.udel.cis.vsl.abc.front.c.parse.IF.CParser.VOLATILE;
