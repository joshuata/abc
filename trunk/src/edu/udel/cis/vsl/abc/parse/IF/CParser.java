...
public interface CParser {
	...
	public static final int BARRIER = CivlCParser.BARRIER;
	public static final int COLLAPSE = CivlCParser.COLLAPSE;
	public static final int COPYIN = CivlCParser.COPYIN;
	public static final int COPYPRIVATE = CivlCParser.COPYPRIVATE;
	public static final int CRITICAL = CivlCParser.CRITICAL;
	public static final int DYNAMIC = CivlCParser.DYNAMIC;
	public static final int FLUSH = CivlCParser.FLUSH;
	public static final int FST_PRIVATE = CivlCParser.FST_PRIVATE;
	public static final int GUIDED = CivlCParser.GUIDED;
	public static final int LST_PRIVATE = CivlCParser.LST_PRIVATE;
	public static final int MASTER = CivlCParser.MASTER;
	public static final int NONE = CivlCParser.NONE;
	public static final int NOWAIT = CivlCParser.NOWAIT;
	public static final int NUM_THREADS = CivlCParser.NUM_THREADS;
	public static final int ORDERED = CivlCParser.ORDERED;
	public static final int PARALLEL = CivlCParser.PARALLEL;
	public static final int PRIVATE = CivlCParser.PRIVATE;
	public static final int REDUCTION = CivlCParser.REDUCTION;
	public static final int RUNTIME = CivlCParser.RUNTIME;
	public static final int SCHEDULE = CivlCParser.SCHEDULE;
	public static final int SECTION = CivlCParser.SECTION;
	public static final int SECTIONS = CivlCParser.SECTIONS;
	public static final int SHARED = CivlCParser.SHARED;
	public static final int THD_PRIVATE = CivlCParser.THD_PRIVATE;
	public static final int Tokens = CivlCParser.Tokens;
