...
public interface ASTNode {
	...
	public enum NodeKind {
		...
		DESIGNATION, ARRAY_DESIGNATOR, FIELD_DESIGNATOR, ENUMERATOR_DECLARATION, FIELD_DECLARATION, VARIABLE_DECLARATION, FUNCTION_DECLARATION, FUNCTION_DEFINITION, TYPEDEF,
		// ALIGNOF,
		// ARROW,
		// CAST,
		// CHARACTER_CONSTANT,
