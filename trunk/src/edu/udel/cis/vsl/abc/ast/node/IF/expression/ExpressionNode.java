...
public interface ExpressionNode extends InitializerNode, SizeableNode,
	...
	public enum ExpressionKind {
		OPERATOR, IDENTIFIER_EXPRESSION, CONSTANT, DOT, ARROW, RESULT, SELF, 
		CAST, SIZEOF, QUANTIFIED_EXPRESSION, DERIVATIVE_EXPRESSION, ALIGNOF, 
		COLLECTIVE, COMPOUND_LITERAL, FUNCTION_CALL, REMOTE_REFERENCE, SCOPEOF, 
		SPAWN
	}
